...
public class CancelHttpHandler implements HttpHandler {

    private final BookingService bookingService;

    public CancelHttpHandler(final BookingService bookingService){
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        try {
            BookingCancellationRequest request = JsonUtil.fromJson(exchange.getRequestBody(), BookingCancellationRequest.class);
            ...
            byte[] errorBytes = JsonUtil.toJsonBytes(new BookingResponse(null, false, "Internal server error: " + e.getMessage(), null));
            exchange.getResponseHeaders().add("Content-Type", "application/json");
