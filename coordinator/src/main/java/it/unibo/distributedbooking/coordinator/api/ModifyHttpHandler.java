...
public class ModifyHttpHandler implements HttpHandler {

    private final BookingCoordinatorService bookingCoordinatorService;

    public ModifyHttpHandler(final BookingCoordinatorService bookingCoordinatorService) {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        try {
            BookingModificationRequest request = JsonUtil.fromJson(exchange.getRequestBody(), BookingModificationRequest.class);
            BookingResponse response = bookingCoordinatorService.coordinateModification(request);
