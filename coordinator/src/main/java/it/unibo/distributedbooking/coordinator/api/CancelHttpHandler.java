...
public class CancelHttpHandler implements HttpHandler {
    ...
    public CancelHttpHandler(final BookingCoordinatorService bookingCoordinatorService) {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        try {
            BookingCancellationRequest request =
                    JsonUtil.fromJson(exchange.getRequestBody(), BookingCancellationRequest.class);
            BookingResponse response =
                    bookingCoordinatorService.coordinateCancellation(request);
